      ...
      <div className="about-content flex flex-col items-center text-center text-white w-full">
        ...
        >
          ...
          <ContactItem title="Email">
            <a className="text-green hover:text-pink underline" href={`mailto:${SOCIAL_LINKS.contactEmail}`}>
              <p className="mt-2">{SOCIAL_LINKS.contactEmail}</p>
            </a>
          </ContactItem>
          <ContactItem title="Phone">
            <p className="mt-2">
              <a className="text-green hover:text-pink underline" href={`tel:${SOCIAL_LINKS.contactPhoneMeghana}`}>Meghana: {SOCIAL_LINKS.contactPhoneMeghana}</a>
            </p>
            <p className="mt-2">
              <a className="text-green hover:text-pink underline" href={`tel:${SOCIAL_LINKS.contactPhoneSrilekha}`}>Srilekha: {SOCIAL_LINKS.contactPhoneSrilekha}</a>
            </p>
          </ContactItem>
