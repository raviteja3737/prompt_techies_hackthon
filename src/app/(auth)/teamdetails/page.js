...
import { BYPASS_AUTH, MOCK_TEAM_DATA, MOCK_USER } from "@/utils/bypassAuth";
import { useAuth } from "@/utils/contexts/AuthContext";

export default function TeamDetails() {
	const [authUser, authLoading] = useAuthState(auth);
	const { user: contextUser } = useAuth();
	const user = BYPASS_AUTH ? (contextUser || MOCK_USER) : authUser;
	const loading = BYPASS_AUTH ? false : authLoading;

	const [teamData, setTeamData] = useState(BYPASS_AUTH ? MOCK_TEAM_DATA : null);
